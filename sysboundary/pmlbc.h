...
namespace SBC
{
    ...
    * 
    * PmlBC is a base class for e.g. SysBoundaryConditon::SetMaxwellian.
    ...
    */
    class PmlBC : public SysBoundaryCondition
    {
    public:
        PmlBC();
        virtual ~PmlBC();
        ...
        // // Vector Containing size of PML Slabs (Public)
        // std::vector<int> PMLSize = {0, 0, 0, 0, 0, 0};
    ...
    protected:
        ...
        // Vector Containing size of PML Slabs 
        // std::vector<int> PMLSize = {0, 0, 0, 0, 0, 0};

        std::multimap<std::string, int> PMLSize = {
                                                    {"X+" , 0},
                                                    {"Y+" , 0},
                                                    {"Z+" , 0},
                                                    {"X-" , 0},
        ...
        std::vector<PmlBCSpeciesParameters> speciesParams;
    };
} // namespace SBC
