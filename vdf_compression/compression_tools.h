...
struct HermSpectrum {
   ...
   std::size_t calculate_total_bytes() const {
      return sizeof(int) + sizeof(float) + 3 * sizeof(float) + HermSpectrum.size() * sizeof(float) + sizeof(size_t) +
             6 * sizeof(Real) + 3 * sizeof(size_t);
   }

   bool serialize_into(char* buffer) const {
