...
OBJS = 	version.o memoryallocation.o backgroundfield.o quadr.o dipole.o linedipole.o vectordipole.o constantfield.o integratefunction.o \
	...
	donotcompute.o ionosphere.o outflow.o outflowPML.o setbyuser.o setmaxwellian.o  \
...
outflowPML.o: ${DEPS_COMMON} sysboundary/outflowPML.h sysboundary/outflowPML.cpp projects/project.h projects/project.cpp fieldsolver/ldz_magnetic_field.cpp
	${CMP} ${CXXFLAGS} ${FLAGS} -c sysboundary/outflowPML.cpp ${INC_FSGRID} ${INC_DCCRG} ${INC_ZOLTAN} ${INC_BOOST} ${INC_EIGEN}
